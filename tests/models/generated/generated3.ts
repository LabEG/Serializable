...
export class Iq4r extends Serializable {
    ...
    @jsonName("gKvAD7vxNt")
    @jsonProperty(String)
    private readonly lqPUSzLo: string = "HRS30ORuiP";

    @jsonName("cNf81oexcV")
    @jsonProperty(void -31, [String], void 34)
    private readonly sCbY?: [string] = void 34;

    @jsonName("kDoG0ZP7")
    @jsonProperty(void -18, [String], Number)
    public y24KRH?: number | [string] = void -18;


    @jsonProperty(void 39, [Number])
    public q6bVgND59: [number] = [73];

    private k3Z6Qp (): number {
        return 0;
    }

    public i5xUZOp (): string {
        return "";
    }
    ...
    public a0GnI4FA (): string {
        return "";
    }

    private kG5stThS (): string {
        return "";
    }
...
export class MN4 extends Serializable {
    ...
    private mvwLJ (): string {
        return "";
    }

    private p3BdlMsUCc7 (): string {
        return "";
    }

    public oso2htp5g5 (): string {
        return "";
    }
...
export class LBiCJ extends Serializable {
    ...
    public qiK: Iq4r | [Iq4r] | [MN4] = new Iq4r();

    @jsonName("k1XDB7DrcdM")
    @jsonProperty(Iq4r)
    private readonly tuSAzol3tV: Iq4r = new Iq4r();

    @jsonName("wvROCzyJdc")
    @jsonProperty(String, [MN4], [Iq4r])
    private readonly sWuGDnktP: string | [Iq4r] | [MN4] = [new MN4()];

    @jsonName("jpg")
    @jsonProperty(MN4, [MN4], [Iq4r])
    public xn3MKDEPJQb: MN4 | [Iq4r] | [MN4] = [new MN4()];

    @jsonName("e3d7tZtqGcQ")
    @jsonProperty(MN4, Iq4r, [MN4])
    private readonly pUQ: Iq4r | MN4 | [MN4] = new MN4();

    private uAJxyDsedn (): number {
        return 0;
    }

    private xPTp2f (): number {
        return 0;
    }

    private pue9Xx (): string {
        return "";
    }
...
export class BX1 extends Serializable {
    ...
    private readonly mPeMnhP: Iq4r | string = "";

    @jsonName("rWc")
    @jsonProperty(Iq4r, String)
    private readonly w6VmLm8l: Iq4r | string = "kRidh8m1";
    ...
    public ewHHWE5 (): string {
        return "";
    }

    private kI8VcsP (): string {
        return "";
    }

    public cfztHEL4z (): number {
        return 0;
    }
...
export class Mpq3M0BpBEg extends Serializable {
    ...
    private readonly q2QvdXEQk: [LBiCJ] | [MN4] = [new MN4()];
    ...
    private readonly rPyzb1DJd: [BX1] | [MN4] = [new BX1()];
...
export class KWGV extends Serializable {
    ...
    private readonly g6Iwi: LBiCJ | [Mpq3M0BpBEg] = [new Mpq3M0BpBEg()];

    @jsonName("jd0pC5l6xgM")
    @jsonProperty(Iq4r)
    private readonly t2hsHBXDy: Iq4r = new Iq4r();

    @jsonName("uaGq")
    @jsonProperty([LBiCJ], Iq4r, void -42)
    public kIsk: Iq4r | [LBiCJ] = new Iq4r();
...
export class PhJVk extends Serializable {
    ...
    private readonly oSrMO2: [MN4] = [new MN4()];

    public gI9xKQCXXo (): string {
        return "";
    }

    public nFsI1HX (): string {
        return "";
    }
    ...
    private mMq0GnS (): number {
        return 0;
    }

    private x8SFeTfiL (): string {
        return "";
    }
...
export class Xt4r7LK3 extends Serializable {
    ...
    public fMFW16?: KWGV | Mpq3M0BpBEg = void -78;
    ...
    @jsonName("wtlg")
    @jsonProperty(Number)
    private readonly dgubUU0hmN: number = -40;

    @jsonName("jOMz3FS")
    @jsonProperty([Date], [KWGV])
    private readonly prPGQXeoIg: [Date] | [KWGV] = [new KWGV()];

    public lUEtRl7TQW (): number {
        return 0;
    }
...
export class JaGKd5NFkvJ extends Serializable {
    ...
    @jsonName("h93I472R")
    @jsonProperty(String)
    private readonly fKEi1Pptkk: string = "zInNmTJ";

    @jsonName("weF9tP")
    @jsonProperty(void 14)
    private readonly g6AaK2S? = void 14;


    @jsonProperty([BX1])
    private readonly mC0YZ0BQ: [BX1] = [new BX1()];

    @jsonName("iQFzsLV")
    @jsonProperty(BX1, void -81)
    private readonly aZJDR: BX1 = new BX1();

    public ufsQoR (): number {
        return 0;
    }

    private r4L2BCmUM (): number {
        return 0;
    }
...
export class So1letl extends Serializable {
    ...
    private readonly tNpwhn: Iq4r | KWGV | [MN4] = [new MN4()];
    ...
    private readonly xxiV: Date | [LBiCJ] = new Date("1995-10-20 16:38:59 UTC");

    private qSoENGYT1Oo (): string {
        return "";
    }

    public tcXb2DPeSk (): number {
        return 0;
    }

    public rl0nWe (): string {
        return "";
    }

    private wpmis (): number {
        return 0;
    }
...
export class EpDCe7C extends Serializable {
    ...
    @jsonName("ws8b")
    @jsonProperty(Iq4r)
    private readonly ef02WBDHEz: Iq4r = new Iq4r();
    ...
    @jsonName("tqg")
    @jsonProperty(BX1)
    private readonly ftB2r: BX1 = new BX1();
    ...
    @jsonName("fS0v")
    @jsonProperty(KWGV)
    private readonly sxEUznJz7bR: KWGV = new KWGV();
    ...
    private readonly eVCdTQzkEgk: Xt4r7LK3 = new Xt4r7LK3();

    @jsonName("f4o6YIbE4C")
    @jsonProperty(JaGKd5NFkvJ)
    private readonly lHu9: JaGKd5NFkvJ = new JaGKd5NFkvJ();

    @jsonName("gbDERM")
    @jsonProperty(So1letl)
    public sEX3Xb5qf: So1letl = new So1letl();

    public tugEyRc (): number {
        return 0;
    }

    public nHg1Bs (): number {
        return 0;
    }

    public q793a9QvAVU (): string {
        return "";
    }
